...
test("developer can browse catalog, create an environment, and review admin readiness", async ({ page }) => {
  ...
  await expect(page.getByRole("tab", { name: "Infrastructure Connect and test" })).toBeVisible();
  ...
  await page.getByRole("tab", { name: "Infrastructure Connect and test" }).click();
  ...
  await page.getByRole("button", { name: "Approve scope berlin-ahv-lab" }).click();
  await page.getByRole("button", { name: "Approve scope Rocky Linux 9 Hardened" }).click();
  await page.getByRole("button", { name: "Approve scope dev-segment-placeholder" }).click();
  await expect(page.getByText("Approved by platform.admin").first()).toBeVisible();
  await expect(page.getByText("Approved scope records")).toBeVisible();
  await page.getByRole("tab", { name: "Providers Config and adapters" }).click();
  ...
  await expect(page.getByText("Approved scope selected")).toBeVisible();
  await expect(page.getByText("berlin-ahv-lab").last()).toBeVisible();
  ...
  await expect(page.getByText("Browser mock controlled create preflight recorded without Prism mutation.")).toBeVisible();
  await expect(page.getByRole("button", { name: "Poll" })).toBeVisible();
  await expect(page.getByRole("button", { name: "Power on" })).toBeDisabled();
  await expect(page.getByRole("button", { name: "Power off" })).toBeDisabled();
  ...
  await expect(page.getByText("Profile, validate, authorize")).toBeVisible();
  await expect(page.getByText("Approve real catalog candidates before create")).toBeVisible();
  await page.getByRole("tab", { name: "Control plane Jobs and approvals" }).click();
  ...
  await expect(page.getByRole("heading", { name: "Production closure authorization" })).toBeVisible();
  await page.getByRole("button", { name: "Record closure authorization" }).click();
  await expect(page.getByText("Production execution closure authorization record")).toBeVisible();
  await expect(page.getByText("Execution closure authorization evidence")).toBeVisible();
  await expect(page.getByText("Outcome authorization ready")).toBeVisible();
  await expect(page.getByRole("heading", { name: "Production closure packet" })).toBeVisible();
  await page.getByRole("button", { name: "Record closure packet" }).click();
  ...
  await expect(page.getByRole("heading", { name: "Production completion dossier" })).toBeVisible();
  await page.getByRole("button", { name: "Record completion dossier" }).click();
  await expect(page.getByText("Production execution completion dossier record")).toBeVisible();
  await expect(page.getByText("Execution completion dossier evidence")).toBeVisible();
  await expect(page.getByText("Final archive certification ready")).toBeVisible();
  await expect(page.getByRole("heading", { name: "Production operations handover" })).toBeVisible();
  await page.getByRole("button", { name: "Record operations handover" }).click();
  await expect(page.getByText("Production execution operations handover record")).toBeVisible();
  await expect(page.getByText("Execution operations handover evidence")).toBeVisible();
  await expect(page.getByText("Completion dossier ready")).toBeVisible();
  await expect(page.getByRole("heading", { name: "Production support readiness" })).toBeVisible();
  await page.getByRole("button", { name: "Record support readiness" }).click();
  await expect(page.getByText("Production execution support readiness record")).toBeVisible();
  await expect(page.getByText("Execution support readiness evidence")).toBeVisible();
  await expect(page.getByText("Operations handover ready")).toBeVisible();
  await expect(page.getByRole("heading", { name: "Production service acceptance" })).toBeVisible();
  await page.getByRole("button", { name: "Record service acceptance" }).click();
  ...
  await expect(page.getByRole("heading", { name: "Production operational closure" })).toBeVisible();
  await page.getByRole("button", { name: "Record operational closure" }).click();
  await expect(page.getByText("Production execution operational closure record")).toBeVisible();
  await expect(page.getByText("Execution operational closure evidence")).toBeVisible();
  await expect(page.getByText("Final turnover ready")).toBeVisible();
  await expect(page.getByRole("heading", { name: "Production post-implementation review" })).toBeVisible();
  await page.getByRole("button", { name: "Record post-implementation review" }).click();
  await expect(page.getByText("Production execution post-implementation review record")).toBeVisible();
  await expect(page.getByText("Execution post-implementation review evidence")).toBeVisible();
  await expect(page.getByText("Operational closure ready")).toBeVisible();
  await expect(page.getByRole("heading", { name: "Production improvement closure" })).toBeVisible();
  await page.getByRole("button", { name: "Record improvement closure" }).click();
  await expect(page.getByText("Production execution improvement closure record")).toBeVisible();
  await expect(page.getByText("Execution improvement closure evidence")).toBeVisible();
  await expect(page.getByText("Post-implementation review ready")).toBeVisible();
  await expect(page.getByRole("heading", { name: "Production final acceptance archive" })).toBeVisible();
  await page.getByRole("button", { name: "Record final acceptance archive" }).click();
  ...
  await expect(page.getByRole("heading", { name: "Production archive retrieval validation" })).toBeVisible();
  await page.getByRole("button", { name: "Record archive retrieval validation" }).click();
  ...
  await expect(page.getByRole("heading", { name: "Production archive recovery acceptance" })).toBeVisible();
  await page.getByRole("button", { name: "Record archive recovery acceptance" }).click();
  await expect(page.getByText("Production execution archive recovery acceptance record")).toBeVisible();
  await expect(page.getByText("Execution archive recovery acceptance evidence")).toBeVisible();
  await expect(page.getByText("Archive recovery drill ready")).toBeVisible();
  await expect(page.getByRole("heading", { name: "Production archive recovery closure" })).toBeVisible();
  await page.getByRole("button", { name: "Record archive recovery closure" }).click();
  await expect(page.getByText("Production execution archive recovery closure record")).toBeVisible();
  await expect(page.getByText("Execution archive recovery closure evidence")).toBeVisible();
  await expect(page.getByText("Archive recovery acceptance ready")).toBeVisible();
  await expect(page.getByRole("heading", { name: "Production archive recovery audit certification" })).toBeVisible();
  await page.getByRole("button", { name: "Record audit certification" }).click();
  await expect(page.getByText("Production execution archive recovery audit certification record")).toBeVisible();
  await expect(page.getByText("Execution archive recovery audit certification evidence")).toBeVisible();
  await expect(page.getByText("Archive recovery closure ready")).toBeVisible();
  await expect(page.getByRole("heading", { name: "Production archive recovery final compliance archive" })).toBeVisible();
  await page.getByRole("button", { name: "Record final compliance archive" }).click();
  ...
  await expect(page.getByRole("heading", { name: "Production archive recovery operational continuity" })).toBeVisible();
  await page.getByRole("button", { name: "Record operational continuity" }).click();
  ...
  await expect(page.getByRole("heading", { name: "Production archive recovery monitoring ownership closure" })).toBeVisible();
  await page.getByRole("button", { name: "Record monitoring closure" }).click();
  await expect(page.getByText("Production execution archive recovery monitoring ownership closure record")).toBeVisible();
  await expect(page.getByText("Execution archive recovery monitoring ownership closure evidence")).toBeVisible();
  await expect(page.getByText("Support ownership acceptance ready")).toBeVisible();
  await expect(page.getByRole("heading", { name: "Production archive recovery final operations handoff" })).toBeVisible();
  await page.getByRole("button", { name: "Record final handoff" }).click();
  await expect(page.getByText("Production execution archive recovery final operations handoff record")).toBeVisible();
  await expect(page.getByText("Execution archive recovery final operations handoff evidence")).toBeVisible();
  await expect(page.getByText("Monitoring ownership closure ready")).toBeVisible();
